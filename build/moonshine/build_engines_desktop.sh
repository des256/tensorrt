#!/usr/bin/env bash
#
# Build TensorRT engines for Moonshine Streaming Medium (desktop profile).
...
ENGINE_DIR="$ROOT_DIR/data/moonshine/engine/desktop"
...
DEC_SHAPES_MAX="input_ids:1x1,encoder_hidden_states:1x1500x768,encoder_attention_mask:1x1500,k_self:14x1x10x64x64,v_self:14x1x10x64x64"
